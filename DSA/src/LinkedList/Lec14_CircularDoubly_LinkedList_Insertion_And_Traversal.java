...
public class Lec14_CircularDoubly_LinkedList_Insertion_And_Traversal {
    Node8 head;
    Node8 tail;
    int size;
    ...
    public static void main(String[] args) {
        ...
        Lec14_CircularDoubly_LinkedList_Insertion_And_Traversal obj = new Lec14_CircularDoubly_LinkedList_Insertion_And_Traversal();
        obj.insertAtEnd(2);
        obj.insertAtEnd(4);
        obj.insertAtEnd(6);
        obj.insertAtEnd(8);
